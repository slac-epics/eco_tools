...
pkgNameAddMacroName( 'ADAndor',				'ADANDOR' )
pkgNameAddMacroName( 'ADAndor3',			'ADANDOR3' )
...
pkgNameAddMacroName( 'ADEuresys',			'ADEURESYS' )
pkgNameAddMacroName( 'ADGenICam',			'ADGENICAM' )
...
pkgNameAddMacroName( 'ADSimDetector',		'ADSIM' )
...
pkgNameAddMacroName( 'ADTucsen',			'ADTUCSEN' )
pkgNameAddMacroName( 'ADUtil',				'ADUTIL' )
pkgNameAddMacroName( 'ADVimba',				'ADVIMBA' )
...
pkgNameAddMacroName( 'ATCACommon',			'ATCACOMMON' )
...
pkgNameAddMacroName( 'devIsegHal',			'DEVISEGHAL' )
...
pkgNameAddMacroName( 'iocLogMsgServer',		'IOCLOGMSGSERVER' )
...
pkgNameAddMacroName( 'perfMeasure',			'PERF_MEASURE' )
